...
Finally, findings validation interviews were conducted by asking how the identified TD items affects the maintainability efforts in a day to day work and which best practices are adopted (if any) to avoid an uncontrolled TD's growth.
%
%
% END DATA GATHERING
%
